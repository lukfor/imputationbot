...
public class ListRefPanelsTest {
	...
	public void testListRefPanels() {
		...
		assertEquals("HapMap 2", listRefPanels.getData()[0][1]);
		assertTrue(listRefPanels.getData()[0][2].contains("eur"));
		assertTrue(listRefPanels.getData()[0][2].contains("mixed"));
		...
		assertEquals("Michigan Imputation Server", listRefPanels.getData()[0][3]);
